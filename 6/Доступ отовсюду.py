...
def shadow_global():
    value = -10
    print("В областе видимости функции shadow_global() значение value ранво", value)
def change_global():
    global value
    value = -10
...
print("Вернемся в глобальную область видимости. Здесь value по-прежнему равно ",value, "\n")
change_global()
print("Вернемся в глобальную область видимости. Здесь value изменилось равно ",value, "\n")
